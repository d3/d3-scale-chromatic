...
```js
var color = d3_scale.scaleOrdinal(d3_scale_chromatic.schemeAccent);
```

To create a diverging color scale using the [PiYG](#interpolatePiYG) color scheme:

```js
var color = d3_scale.scaleSequential(d3_scale_chromatic.interpolatePiYG);
```
